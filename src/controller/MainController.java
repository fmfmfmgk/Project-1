	...
	private void start() {
		...
		while (true) {
			...
			case FEEDBACK_INSERT:
				view = user.feedInsert();
				break;
			case FEEDBACK_UPDATE:
				view = user.feedUpdate();
				break;
			case FEEDBACK_DELETE:
				view = user.feedDelete();
				break;
			case TKTGETLIST:
				view = tktGetList();
				break;
			...
			case CART_LIST:
				...
				break;
			case CART_BUY_LIST:
				view = user.cartBuyList();
				break;
			case CART_BUY:
				view = user.cartBuy();
				break;
			case CART_UPDATE:
				view = user.cartUpdate();
				break;
